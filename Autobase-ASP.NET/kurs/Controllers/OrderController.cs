...
namespace Autobase.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult UpdateOrder(string orderId, string requiredCarSpeed, string requiredCarCapacity)
        {
            try
            {
        ...
        public ActionResult GetModalWindow()
        {
        ...
        {
            order.Status = TripStatusEnum.WAITING;
